...
public class PlanListService extends Service {
    ...
    private Notification getNotification(){
        Notification.Builder builder=new Notification.Builder(MyApplication.getContext())
                ...
                .setAutoCancel(true)
                .setContentIntent(PendingIntent.getActivity(MyApplication.getContext(),111, new Intent(MyApplication.getContext(), MainActivity.class),0));
